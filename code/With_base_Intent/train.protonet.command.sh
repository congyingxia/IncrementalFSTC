...
CUDA_VISIBLE_DEVICES=0 python -u train.protonet.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
...
CUDA_VISIBLE_DEVICES=1 python -u train.protonet.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
...
CUDA_VISIBLE_DEVICES=2 python -u train.protonet.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
...
CUDA_VISIBLE_DEVICES=3 python -u train.protonet.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
...
CUDA_VISIBLE_DEVICES=4 python -u train.protonet.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
...
CUDA_VISIBLE_DEVICES=5 python -u train.protonet.py \
    --task_name rte \
    --do_train \
    --do_lower_case \
    --num_train_epochs $EPOCHSIZE \
